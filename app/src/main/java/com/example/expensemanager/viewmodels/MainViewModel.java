...
//        realm.copyToRealmOrUpdate(new Transaction(Constants.EXPENSE,"Investment","Bank","some note here",new Date(),-700,new Date().getTime()));
//        realm.copyToRealmOrUpdate(new Transaction(Constants.EXPENSE,"Rent","Card","some note here",new Date(),-300,new Date().getTime()));
//        realm.copyToRealmOrUpdate(new Transaction(Constants.INCOME,"Business","Cash","some note here",new Date(),500,new Date().getTime()));
